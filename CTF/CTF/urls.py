...
urlpatterns = [
    ...
    url(r'^manage/exercise_question_index$', manager.re_exercise_questions_index),
    ...
    url(r'^manage/megagame_question_detail$', manager.re_megagame_question_detail),
    ...
    url('^accessory/(?P<path>.*)$', serve, {'document_root': settings.MEDIA_ROOT}),
